...
window.onload = function load() {
	...
	setdata("https://sthlm."+window.location.host+"/c","°C",1,"la_ute_temp")
	setdata("https://sthlm."+window.location.host+"/d","%",0,"la_ute_fukt")
	setdata("https://sthlm."+window.location.host+"/a","°C",1,"la_inne_temp")
	setdata("https://sthlm."+window.location.host+"/b","%",0,"la_inne_fukt")
